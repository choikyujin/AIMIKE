...
namespace TextSpeech
{
    public class SpeechToText : MonoBehaviour
    {
...
#elif UNITY_ANDROID
        AndroidJavaClass javaUnityClass = new AndroidJavaClass("com.scc.unitystt.Bridge");
        ...
        {            
            ...
            Debug.Log("StartRecording1 : " + _message);
        }
        else
        {
            AndroidJavaClass javaUnityClass = new AndroidJavaClass("com.scc.unitystt.Bridge");
            javaUnityClass.CallStatic("StartRecording");
            Debug.Log("StartRecording2 : " + _message);
        }
#endif
        }
        ...
        {
            Debug.Log("onMessage : " + _message);
        }

        public void onErrorMessage(string _message)
        {
            Debug.Log("onErrorMessage : " + _message);
        }
